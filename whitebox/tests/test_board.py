...
def test_get_tile_type():
    ...
    # Tile 4 is Income Tax or similar, but let's check a property tile specifically
    assert board.get_tile_type(1) == "property" # Mediterranean Avenue
    # Board size is 40, check out of bounds or unused tile just in case it's blank
